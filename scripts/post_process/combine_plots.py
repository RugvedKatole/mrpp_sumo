...
def main(param):
    ...
    plt.suptitle('Node Idlesness vs Time, utils', size = 40, y = 1.02, x = 0.4)
    plt.savefig('{}/Plots/avg_idle_utils___{}.png'.format(dirname, str(i/12)), bbox_inches='tight')
